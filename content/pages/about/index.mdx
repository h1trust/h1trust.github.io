...
[中文](https://github.com/h1trust/about/blob/master/README.md) | [English](https://github.com/h1trust/about/blob/master/README-EN.md)
...
- 宣传 Rust，投入其生态以及社区。
- 维护 [awesome list](https://github.com/h1trust/awesome-hit-rust)，分享 Rust 相关资源和有趣的项目。
